...
import { Table, TableHead, TableHeader, TableRow } from '@/components/ui/table'; //使用表格组件
...
function ProjectDetailsContent() {
    ...
    const handleLanguageChange = (newLanguageCode: string) => {
        ...
        if (projectName) {
            router.push(
                `/public/Entries?project_name=${encodeURIComponent(projectName)}&language_code=${encodeURIComponent(newLanguageCode)}`
            );
        }
    };
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-start space-x-2">
                                        <div className="flex-1 pr-2 text-gray-800">
                                            {entry.msgid}
                                        </div>
