...
export default function Welcome() {
    ...
    const steps = [
        ...
        },
        {
            ...
            description:
                'Go to your Dashboard to view and manage your projects.',
            image: '/image/3.PNG',
        },
        {
        ...
        },
        {
            ...
            description:
                'Inside the project, select the language you wish to translate.',
            image: '/image/5.PNG',
        },
        {
            title: 'Step 6: Start Translating by Selecting a Term',
            description:
                'Select a term in the language interface to start translating.',
            image: '/image/6.PNG',
        },
        {
            title: 'Step 7: Enter the Translation Interface and Begin Translating',
            description:
                "Now you're in the translation interface, ready to start your work.",
            image: '/image/7.PNG',
        },
    ];
